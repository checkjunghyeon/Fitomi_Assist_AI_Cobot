...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InferenceResult_message_member_array[3] = {
  {
    "class_name",  // name
    ...
    offsetof(custom_interfaces::msg::InferenceResult, class_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::InferenceResult, coordinates),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::InferenceResult, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
