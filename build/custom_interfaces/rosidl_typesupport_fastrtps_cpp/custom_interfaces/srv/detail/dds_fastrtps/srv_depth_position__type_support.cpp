...
#include "custom_interfaces/srv/detail/srv_depth_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::srv::SrvDepthPosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::SrvDepthPosition_Request & ros_message)
{
  // Member: target
  cdr >> ros_message.target;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::srv::SrvDepthPosition_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::SrvDepthPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::SrvDepthPosition_Request *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SrvDepthPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, SrvDepthPosition_Request)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SrvDepthPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::srv::SrvDepthPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::SrvDepthPosition_Response & ros_message)
{
  // Member: depth_position
  {
    cdr >> ros_message.depth_position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::srv::SrvDepthPosition_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::SrvDepthPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::SrvDepthPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SrvDepthPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, SrvDepthPosition_Response)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SrvDepthPosition_Response__handle;
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SrvDepthPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, SrvDepthPosition)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SrvDepthPosition__handle;
}
