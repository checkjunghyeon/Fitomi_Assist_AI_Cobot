...
{
  new (message_memory) custom_interfaces::srv::SrvDepthPosition_Request(_init);
}

void SrvDepthPosition_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::srv::SrvDepthPosition_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SrvDepthPosition_Request_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces::srv::SrvDepthPosition_Request, target),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SrvDepthPosition_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::srv::SrvDepthPosition_Request),
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SrvDepthPosition_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, SrvDepthPosition_Request)() {
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SrvDepthPosition_Request_message_type_support_handle;
}
...
void SrvDepthPosition_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) custom_interfaces::srv::SrvDepthPosition_Response(_init);
}

void SrvDepthPosition_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::srv::SrvDepthPosition_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SrvDepthPosition_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::srv::SrvDepthPosition_Response, depth_position),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SrvDepthPosition_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::srv::SrvDepthPosition_Response),
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SrvDepthPosition_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, SrvDepthPosition_Response)() {
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SrvDepthPosition_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SrvDepthPosition_service_members = {
  ...
  // see get_service_type_support_handle<custom_interfaces::srv::SrvDepthPosition>()
...
get_service_type_support_handle<custom_interfaces::srv::SrvDepthPosition>()
{
  ...
  auto service_type_support =
    &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SrvDepthPosition_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, SrvDepthPosition)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<custom_interfaces::srv::SrvDepthPosition>();
}
